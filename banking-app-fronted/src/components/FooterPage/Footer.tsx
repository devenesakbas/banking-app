...
export const Footer: React.FC = () => {
  return (
    <footer className="bg-blue-50 border-t border-gray-100 text-gray-600">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 lg:py-16">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 lg:gap-12 mb-12">
          ...
          <div>
            ...
            <a href="tel:+90850 000 00 00" className="text-sm font-semibold text-gray-800 mb-1 hover:text-blue-600">0850 000 00 00</a>
            <p className="text-[11px] text-gray-500 mb-3">7/24 Kesintisiz Destek Hattı</p>
            <p className="text-gray-800 text-sm font-semibold mb-1">Bizleri takip edin</p>
        ...
        <div className="pt-8 border-t border-gray-100 flex flex-col sm:flex-row items-center justify-between gap-4">
          <p className="text-xs text-gray-400 text-center sm:text-left">
            &copy; {new Date().getFullYear()} Tüm hakları saklıdır. ENAK Bankacılık A.Ş.
          </p>
