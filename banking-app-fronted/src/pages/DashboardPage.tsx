...
function DashboardPage() {
  const [currencyGA, setCurrencyGA] = useState<{
    price: number;
    ration: string;
    changeType: string;
    symbol: string;
  ...
  const getCurrency = async () => {
    ...
    console.log("USD:", currencyUSD);
    console.log("EUR:", currencyEUR);
    console.log("GA:", currencyGA);
    console.log("BTC:", currencyBTC);
  };
        ...
        <div className="grid grid-cols-2 sm:grid-cols-4 gap-4">
          <div className="bg-white p-4 rounded-xl border border-gray-200 shadow-xs flex items-center justify-between">
            ...
            <span
              className={
                currencyUSD !== null
                  ? "text-emerald-600 bg-emerald-50 text-xs font-semibold px-2 py-1 rounded"
                  : "text-rose-600 bg-rose-50 text-xs font-semibold px-2 py-1 rounded"
              }
            >
              {currencyUSD !== null ? "%" + currencyUSD.ration : ""}
            </span>
          </div>
          <div className="bg-white p-4 rounded-xl border border-gray-200 shadow-xs flex items-center justify-between">
            <div>
            ...
            >
              {currencyEUR !== null ? "%" + currencyEUR.ration : ""}
            </span>
          </div>
          <div className="bg-white p-4 rounded-xl border border-gray-200 shadow-xs flex items-center justify-between">
            <div>
            ...
            >
              {currencyGA !== null ? "%" + currencyGA.ration : ""}
            </span>
          </div>
          <div className="bg-white p-4 rounded-xl border border-gray-200 shadow-xs flex items-center justify-between">
            <div>
            ...
            >
              {currencyBTC !== null ? "%" + currencyBTC.ration : ""}
            </span>
          </div>
        </div>
